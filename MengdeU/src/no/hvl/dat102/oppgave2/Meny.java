	...
	public static void main(String[] args) {
		...
		while(input != 0) {
			...
			case 1: Medlem m = Teksgrensesnitt.lesMedlem();
					...
					break;
			case 2: System.out.println("Skriv inn navn på medlem:");
			...
			case 3: Teksgrensesnitt.skrivParListe(arkiv);
					break;
			case 4: System.out.println("Skriv inn navn på medlem:");
					navn = leser.nextLine();
					...
					break;
			case 5: System.out.println("Skriv inn navn på medlem:");
					navn = leser.nextLine();
					arkiv.tilbakestillStatusIndeks(navn);
					break;
			case 6: System.out.println("Skriv navnet på det første medlemmet:");
					...
					break;
			case 7: System.out.println("Skriv navnet på det første medlemmet:");
					...
					break;
			case 8:	System.out.println("Skriv navnet på det første medlemmet:");
					navnM1 = leser.nextLine();
					System.out.println("Skriv navnet på det andre medlemmet:");
					navnM2 = leser.nextLine();
					i1 = arkiv.finnMedlemIndeks(navnM1);
					...
					break;
			case 9: System.out.println("Skriv navnet på det første medlemmet:");
					navnM1 = leser.nextLine();
					System.out.println("Skriv navnet på det andre medlemmet:");
					navnM2 = leser.nextLine();
					i1 = arkiv.finnMedlemIndeks(navnM1);
